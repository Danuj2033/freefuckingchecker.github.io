...
<html class="loading">
  <head>
    ...
    <title>FREEFUCKINGCHECKER</title>
...
<h4 class="mb-2"><strong>FUCKING STRIPE CHECKOUT</strong></h4>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body text-center">
					...
					<div class="input-group mb-1">
									 <input type="text" style="background-color:#112132; width: 25px;" class="form-control" id="ip" placeholder="ip:port" name="ip">
					<input type="text" style="background-color:#112132;width: 25px;" class="form-control" id="hydra" placeholder="Proxy Account" name="hydra">
					</div>
